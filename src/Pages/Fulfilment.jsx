...
function Fulfilment({sell=false}) {
  ...
  return (
    <section className='section-margin'>
        <Heading className='text-primary text-center fs-48 font-weight-bold py-5' text={`Approve Fulfilment`} />
        <div className='container'>
            <div className='row justify-content-center'>
                <div className='col-12 col-lg-6'>
                    <div className="mb-3 w-100">
                        <label htmlFor="items" className="form-label">Approve Fulfilment</label>
              <input
        type="text"
        id="inputBox"
        value={inputValue}
